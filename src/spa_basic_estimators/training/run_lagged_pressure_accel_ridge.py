...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the lagged pressure+accelerometer ridge baseline."
    )
    parser.add_argument(
        "--data-config",
    ...
    parser.add_argument(
        ...
        help="Path to the lagged pressure+accelerometer ridge config YAML.",
    )
    return parser
...
def main() -> None:
    ...
    result = run_lagged_pressure_accel_ridge(
